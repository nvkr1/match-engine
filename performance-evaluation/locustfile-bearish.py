...
jtl_url = os.getenv('JTL_URL') or 'http://demo-exchange-jtl-service'
jtl_token = os.getenv('JTL_TOKEN') or 'at-5c829081-62d6-442b-8496-a16febb3cf72'
jtl_project = os.getenv('JTL_PROJECT') or 'Demo Exchange'
jtl_scenario = os.getenv('JTL_SCENARIO') or 'Bullish Scenario'
jtl_environment = os.getenv('JTL_ENV') or 'test'
engine_url = os.getenv('ENGINE_URL') or 'http://match-engine-btc-usdt-service/BTC-USDT'
